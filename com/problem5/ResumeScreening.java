...
public class ResumeScreening {
    public static void main(String[] args) {
        ...
        // Creating resumes
        Resume<SoftwareEngineer> seResume = new Resume<>("Abhishek Vishwakarma", new SoftwareEngineer());
        Resume<DataScientist> dsResume = new Resume<>("Ayush Kushwaha", new DataScientist());
        Resume<ProductManager> pmResume = new Resume<>("Sahil Ganeshwani", new ProductManager());
