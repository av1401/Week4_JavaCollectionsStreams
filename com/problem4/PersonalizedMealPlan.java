...
public class PersonalizedMealPlan {
    public static void main(String[] args) {
        ...
        // Creating meals
        Meal<VegetarianMeal> vegMeal = new Meal<>("Grilled Vegetable Sandwitch", new VegetarianMeal());
        Meal<VeganMeal> veganMeal = new Meal<>("Salad", new VeganMeal());
        Meal<NonVegMeal> NonVeg = new Meal<>("Avocado Chicken", new NonVegMeal());
