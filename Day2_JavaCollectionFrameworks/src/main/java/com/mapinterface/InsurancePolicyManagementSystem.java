...
public class InsurancePolicyManagementSystem {
    public static void main(String[] args) {
        ...
        system.addPolicy(new InsurancePolicy("P007", "Abhishek", LocalDate.now().plusDays(10), 500.0));
        ...
        system.addPolicy(new InsurancePolicy("P178", "Shruti", LocalDate.now().plusDays(5), 800.0));
        ...
        // Retrieve a policy
        System.out.println("\nRetrieving Policy P138:");
        System.out.println(system.getPolicy("P138"));
        ...
        for (InsurancePolicy policy : system.getPoliciesByHolder("Abhishek")) {
            System.out.println(policy);
        }
